...
assert_success "Model configuration should be loaded" "config_is_loaded 'models'"
...
# Note: This would normally modify the config file, but we'll test the validation logic
